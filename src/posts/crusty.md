...
date: '2026-01-23'
title: Disassembly
pageDesc: 'On pure engineering. Or something.'
...
Now that I am (I guess) a technical person, I still learn by taking things apart. I am slow. I am methodical. I am a systems person. I hate that so many people in my industry consider that to be some kind of liability. What can I say? I was educated by Jesuits. You learn the fundamentals, however long it takes, and then you see all the abstractions and shiny things for what they are. You know where things came from, so you can chart where the inflections into abstraction happen. And within all those inflections, there are politics, there are elisions, there are affordances, there are ommissions, there is subjectivity, there are _angles_.

In benign contexts, all this knowledge just makes you seem like a wizard when you're called upon to debug something. In less benign contexts, you can see that even in software engineering, there are dehumanizing choices. There are so many shiny abstractions out there now. Some are harmless. A small yet very popular subset are insidious obfuscation engines - every line of code is a "just trust me bro".

You really shouldn't, though. You should keep trying to know things. Calmly, methodically. Find the joy in that.
